...
class __TwigTemplate_7853b25db7e074bb657132cfb3b28d81 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 25)) {
                // line 26
                yield "      <div";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 26), "addClass", ["description"], "method", false, false, true, 26), 26, $this->source), "html", null, true);
                yield " >";
...
";
  ...
  ";
    ...
    {
        return new Source("", "themes/restaurant_zymphonies_theme/templates/form/field-multiple-value-form.html.twig", "D:\\wamp\\www\\varshneykitchen\\themes\\restaurant_zymphonies_theme\\templates\\form\\field-multiple-value-form.html.twig");
    }
